...
///
/// Returns `null` (serialised as `None`) if no view hook is registered for the
/// note's schema. The returned HTML is built by the Rhai display-helper DSL and
/// should be sanitised on the frontend before rendering.
///
/// # Errors
///
